    ...
    */
    ...
    async _handleMessage(message) {
        ...
        if (message._fetchProp) {
            ...
            try {
                this._respond('evalOnCluster', { _sClusterEvalResponse: await this._eval(message._sClusterEvalRequest), nonce: message.nonce, cluster: message.cluster });
            } catch (err) {
    ...
    _eval(script) {
        ...
        this.client._eval = (function(_){eval(_)}).bind(this.client);
